...
app.post('/prevchat', (req,res) => {
    ...
    connection.query(`select chats.id,chats.content as message,chats.imgUrl, chats.date,user.nickname from chats, user where chats.accountidx = user.id ORDER BY id LIMIT ${p}, 50;`, (err,result) => {
